...
VALUES
    ('best_of_the_week_31_03_2026', 50, '50 USDT', NULL, EXTRACT(EPOCH FROM NOW())::BIGINT * 1000, EXTRACT(EPOCH FROM NOW())::BIGINT * 1000),
    ('best_of_the_week_31_03_2026', 30, '30 USDT', NULL, EXTRACT(EPOCH FROM NOW())::BIGINT * 1000, EXTRACT(EPOCH FROM NOW())::BIGINT * 1000),
    ('best_of_the_week_31_03_2026', 10, '10 USDT', NULL, EXTRACT(EPOCH FROM NOW())::BIGINT * 1000, EXTRACT(EPOCH FROM NOW())::BIGINT * 1000)
...
VALUES
    (
        'best_of_the_week_31_03_2026_first',
        'Best of the Week',
        'Best of the Week: 1st Place',
        'https://mrkriodev.github.io/mrkrio.github.io/data/events/event-weekly-3.png',
        'Finish 1st place in Best of the Week competition.',
        'event',
        (SELECT id FROM prize_values WHERE event_id = 'best_of_the_week_31_03_2026' AND value = 50 LIMIT 1),
        1,
        'Claim event prize',
        EXTRACT(EPOCH FROM NOW())::BIGINT * 1000,
        EXTRACT(EPOCH FROM NOW())::BIGINT * 1000
    ...
    (
        'best_of_the_week_31_03_2026_second',
        'Best of the Week',
        ...
        'event',
        (SELECT id FROM prize_values WHERE event_id = 'best_of_the_week_31_03_2026' AND value = 30 LIMIT 1),
        1,
        'Claim event prize',
        EXTRACT(EPOCH FROM NOW())::BIGINT * 1000,
        EXTRACT(EPOCH FROM NOW())::BIGINT * 1000
    ...
    (
        'best_of_the_week_31_03_2026_third',
        'Best of the Week',
        'Best of the Week: 3rd Place',
        'https://mrkriodev.github.io/mrkrio.github.io/data/events/event-weekly-1.png',
        'Finish 3rd place in Best of the Week competition.',
        'event',
        (SELECT id FROM prize_values WHERE event_id = 'best_of_the_week_31_03_2026' AND value = 10 LIMIT 1),
        1,
        'Claim event prize',
        EXTRACT(EPOCH FROM NOW())::BIGINT * 1000,
        EXTRACT(EPOCH FROM NOW())::BIGINT * 1000
